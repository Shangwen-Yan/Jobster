<?php
    ...
    //get number of unread msg of one specific user
    function get_cnt_unread($sid1,$sid2,$con){
        $sql = "select count(*) as cnt from message where sid1 = ".$sid1." and sid2 = ".$sid2." and status = 0;";
    ...
    //unique without-unread students
    $sql_stu1 = "select distinct sid1 from message where sid2='$sid' and sid1 not in (select distinct sid1 from message where sid2='$sid' and status = 0);";
    $result_stu1= mysqli_query($con,$sql_stu1);
    $count_stu1=mysqli_num_rows($result_stu1);

    //unique send but not received students
    $sql_stu2 = "select distinct sid2 from message where sid1='$sid' and sid2 not in (select distinct sid1 from message where sid2='$sid' and status = 0) and sid2 not in (select distinct sid1 from message where sid2='$sid');";
    $result_stu2= mysqli_query($con,$sql_stu2);
    $count_stu2=mysqli_num_rows($result_stu2);
        ...
        $(".open").click(function(){
            ...
            type :'POST',
                ...
                success:function(msg){
                    $("#msg_history").prev().prev().html("<a href='stu_sblog.php?ssid="+msg[0].sid1+"'>"+msg[0].sname1+"</a>")
                        ...
                        <div class="work-progres">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        for ($i = 0; $i < $count_stu0; $i++){
                                            if($row=mysqli_fetch_assoc($result_stu0)){
                                                $sid1_stu0 = $row['sid1'];

                                                $sname = get_stu_name($sid1_stu0,$con);

                                                $suni = get_stu_uni($sid1_stu0,$con);
                                                $cnt = get_cnt_unread($sid1_stu0,$sid,$con);
                                                echo "
                                                    <tr>
                                                        <td><img src=\"images/stu/s".$sid1_stu0.".jpg\" alt=\"\" height=\"25\" width=\"25\"></td>
                                                        <td >".$sname."</td>
                                                        <td colspan=\"2\">".$suni."</td>
                
                                                        <td><span class=\"label label-danger\">".$cnt."</span></td>
                                                        <td ><span  id='open' class=\"label label-info open\">open</span><span id='sid' hidden>".$sid1_stu0."</span></td>
                                                    </tr>
                                                ";
                                    ...
                                    <?php
                                    for ($i = 0; $i < $count_stu1; $i++){
                                        if($row=mysqli_fetch_assoc($result_stu1)){
                                            $sid1_stu1 = $row['sid1'];

                                            $sname = get_stu_name($sid1_stu1,$con);

                                            $suni = get_stu_uni($sid1_stu1,$con);
                                            echo "
                                                    <tr>
                                                        <td><img src=\"images/stu/s".$sid1_stu1.".jpg\" alt=\"\" height=\"25\" width=\"25\"></td>
                                                        <td >".$sname."</td>
                                                        <td colspan=\"2\">".$suni."</td>
                
                                                        <td><span class=\"label label-success\">0</span></td>
                                                        <td ><span id='open' class=\"label label-info open\">open</span><span id='sid' hidden>".$sid1_stu1."</span></td>
                                                    </tr>
                                                ";
                                    ...
                                    ?>
                                    <?php
                                    for ($i = 0; $i < $count_stu2; $i++){
                                        if($row=mysqli_fetch_assoc($result_stu2)){
                                            $sid2_stu2 = $row['sid2'];

                                            $sname = get_stu_name($sid2_stu2,$con);

                                            $suni = get_stu_uni($sid2_stu2,$con);
                                            echo "
                                                    <tr>
                                                        <td><img src=\"images/stu/s".$sid2_stu2.".jpg\" alt=\"\" height=\"25\" width=\"25\"></td>
                                                        <td >".$sname."</td>
                                                        <td colspan=\"2\">".$suni."</td>
                
                                                        <td><span class=\"label label-success\">0</span></td>
                                                        <td ><span id='open' class=\"label label-info open\">open</span><span id='sid' hidden>".$sid2_stu2."</span></td>
                                                    </tr>
                                                ";
