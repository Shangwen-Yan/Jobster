<?php
    ...
    //for body
    //all applications
    $sql_application="select jid,cid,title,cname,status,appTime from application inner join job using (jid) inner join company using(cid) where sid='$sid' order by appTime desc;";

    $result_application= mysqli_query($con,$sql_application);
    $count_application=mysqli_num_rows($result_application);
                        ...
                        <div class="work-progres">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        for ($i = 0; $i < $count_application; $i++){
                                            if($row=mysqli_fetch_assoc($result_application)){
                                                $cid = $row['cid'];
                                                $cname = $row['cname'];
                                                $title = $row['title'];
                                                $jid = $row['jid'];
                                                ...
                                                if ($status==0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class=\"label label-info\">unread</span></td>
                                                ...
                                                ";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class=\"label label-warning\">unreplied</span></td>
                                                        <td ><span  id='open' class=\"label label-info open\">open</span><span  hidden>".$jid."</span></td>
                                                    </tr>
                                                ";
