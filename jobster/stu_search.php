...
if($stu_search != ""){
    ...
    $sql_stu="select sname,sid,university,major from student where sid != '$sid';";
}
...
<script type="text/javascript" language="JavaScript">
    $(function() {
        ...
        $(".open").click(function(){
            ...
            $.ajax({
                ...
                success:function(msg){
                    $("#stu_detail").prev().html("<a href='stu_sblog.php?ssid="+msg.sid1+"'>"+msg.sname+"</a>")
                    $("#comp_sid").html(msg.sid1);
                    if(msg.open == 0){
        ...
        $("[type='button']").click(function () {
            ...
            $.ajax({
                url:'request_friendship.php',
                data:{'msg':$("[type='button']").prev().val(),'sid2':$("#comp_sid").html(),'sid1':<?php echo $sid?>},
                type :'POST',
                dataType:'JSON',
                success:function(msg){
                    if(msg.msg=='success'){
                        alert("You have request successfully!")
                    }else{
                    ...
                    <div class="col-md-6 chart-layer1-right" id = "msg_right" style="display: none; width: 40%" >
                        <div class="user-marorm">
                            ...
                            <div class="malorm-bottom">
                                ...
                                <form id="send_form">
                                    <input type="text" value=""  placeholder="request msg...">
                                    <input type="button" value="request" style="margin-left:250px ">
                                </form>
                            </div>
                        </div>
                    </div>
