<?php
    ...
    $ssid=mysqli_real_escape_string($con,$_GET['ssid']);
    //for  header
    //message
    ...
    //for body
    //all student posts
    $sql_posts="SELECT sid, postTime, msg FROM Jobster.StudentPost where sid = '$ssid' order by postTime desc;";
    $result_posts= mysqli_query($con,$sql_posts);
    $count_posts=mysqli_num_rows($result_posts);


    //getprofile
    $sql_profile = " select sname,resumeText,university,qualification,major,gpa,startDate,endDate,seenbyall from Student where sid = '$ssid' ;";
    ...
    //if hide
    $sql_hide = "select hide from relationship where sid1 = '$ssid' and sid2 = '$sid';";
                                    ...
                                    <?php
                                        if($arr['open']==1){
                                            echo "
                                                    <h2>".$arr['sname']."</h2><hr>
                                                    <span id=\"msg_history\">
                                                        <p style=\"text-align: left; \"><b>University: </b>".$arr['university']."</p>
                                                        <p style=\"text-align: left; \"><b>Qualification: </b>".$arr['qualification']."</p>
                                                        <p style=\"text-align: left; \"><b>Major: </b>".$arr['major']."</p>
                                                        <p style=\"text-align: left; \"><b>GPA: </b>".$arr['gpa']."</p>
                                                        <p style=\"text-align: left; \"><b>Start Date: </b>".$arr['startDate']."</p>
                                                        <p style=\"text-align: left; \"><b>End Date: </b>".$arr['endDate']."</p>
                                                        <td><p style=\"text-align: left; \"><b>Resume Text: </b>".$arr['resumeText']."</p></td>
                                                    </span><hr/>
