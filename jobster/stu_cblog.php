<?php
    ...
    //for  hmysqli_real_escape_string($sid);eader
    //message
    ...
    //for body
    //all company posts
    $sql_posts="SELECT cid, postTime, msg FROM Jobster.CompanyPost where cid = '$cid' order by postTime desc;";
    $result_posts= mysqli_query($con,$sql_posts);
    $count_posts=mysqli_num_rows($result_posts);

    //get company profile
    $sql_profile = " select cid,cname,location,industry,magnitude,cdesc from company where cid = '$cid'";
                                ...
                                <table class="table table-hover">
                                    ...
                                    for ($i = 0; $i < $count_posts; $i++){
                                        if($row=mysqli_fetch_assoc($result_posts)){
                                            ...
                                            echo "
                                                    <tr>
                                                        <td><img src=\"images/comp/c".$cid_post.".png\" alt=\"\" height=\"25\" width=\"25\"></td>
                                                        <td colspan=\"3\">".$msg."</td>
                            ...
                            <div class="malorm-bottom">
                                ...
                                if($row=mysqli_fetch_assoc($result_profile)){
                                    echo "
                                                    <h2>".$row['cname']."</h2><hr>
                                                    <span id=\"msg_history\">
                                                        <p style=\"text-align: left; \"><b>Location: </b>".$row['location']."</p>
                                                        <p style=\"text-align: left; \"><b>Industry: </b>".$row['industry']."</p>
                                                        <p style=\"text-align: left; \"><b>Magnitude: </b>".$row['magnitude']."</p>
                                                        <td><p style=\"text-align: left; \"><b>Resume Text: </b>".$row['cdesc']."</p></td>
                                                    </span><hr/>
